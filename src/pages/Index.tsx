...
export default function Index() {
  ...
  const projects: Project[] = [
    ...
    { url: webpages3, alt: "Verkkosivusuunnittelu: portfoliosivuston näkymä", category: "Web and App Design", objectPosition: "top" },
    {
      ...
      description: "Olen kuvannut henkilökuvia yrityksille, seuroille ja järjestöille markkinointikäyttöön, mm. ehdokaskuvia, tapahtumajulisteita ja näyttelymainoksia. Asiakkaitani ovat olleet mm. TAIKE, Leijonaemot ry., Suomen Taiteilijaseuran Ateljeesäätiö, Lempäälän Vihreät ry., Kulttuurikeskus PiiPoo, Espoo Ciné.",
      galleryImages: [
            ...
            <div style={{ flex: "1 1 60%", minWidth: isMobile ? 0 : 300, width: "100%", overflow: "visible", opacity: heroVisible ? 1 : 0, transform: heroVisible ? "translateY(0)" : (prefersReducedMotion ? "translateY(0)" : "translateY(40px)"), transition: prefersReducedMotion ? "none" : "opacity 0.8s ease-out, transform 0.8s ease-out" }}>
              ...
              <div style={{ maxWidth: 600, opacity: heroVisible ? 1 : 0, transition: prefersReducedMotion ? "none" : "opacity 0.8s ease-out 0.8s" }}>
                <p style={{ fontSize: isMobile ? 17 : 20, color: "#1e293b", lineHeight: 1.5, marginBottom: "2rem", fontFamily: "'EB Garamond', serif", fontWeight: 500, letterSpacing: "0.5px" }}>
                  Taustani graafisessa suunnittelussa, valokuvauksessa ja ihmistyössä antaa minulle vahvan pohjan digitaaliseen tuotekehitykseen. Työskentelen mieluiten teknologian, muotoilun ja ihmisten rajapinnassa, tuoden mukani visuaalista näkemystä, viestintätaitoja sekä ymmärrystä siitä, miten käyttöliittymät ja koodi toimivat yhdessä. Syvennän osaamistani jatkuvasti AI-avusteisessa muotoilussa ja kokeilevassa kehityksessä (mm. Lovable, Claude, Cursor), ja minulta löytyy joustavuutta toimia myös UI/UX-tehtävissä.<br /><br />Hallitsen HTML:n, CSS:n ja JavaScriptin perusteet ja opiskelen parhaillaan Reactia modernin front-end kehityksen intensiiviopinnoissa. Versionhallinnassa luotan GitHubiin ja koodin laadunvarmistuksessa hyödynnän CodeRabbitia.<br /><br />Uskon, että parhaat digitaaliset tuotteet syntyvät empatiasta. Ihmisläheinen työkokemukseni auttaa minua luomaan saavutettavia ratkaisuja, jotka oikeasti palvelevat käyttäjäänsä. Tekoäly on kiinteä osa työnkulkuani – se antaa minulle mahdollisuuden keskittyä enemmän luovuuteen, käytettävyyteen ja ratkaisujen hiomiseen.
                </p>
